...
<div class="content">					<!-- 전체 -->
	...
	<div class="topsubBannerAll">		<!-- 슬라이드배너 아래쪽 서브배너 -->
		<div class="topsubBanner">
				<img class="dummy" src="./resources/img/banner/sub/1.jpg">
				<img class="dummy" src="./resources/img/banner/sub/2.jpg">
		</div>
	</div>
	<div class="mainEventCon">			<!-- 상품리스트 배너 -->
		<div class="mainEventBanner">
			<img class="dummy" src="./resources/img/banner/event/1.jpg" width="1285">
		</div>
