...
.deletebtn {
	margin-right: 10px;
		...
		<div class="qnatitle">
			...
			<input type="button" class="qnabtn" id="qnabtn" value="글쓰기" />
		</div>

		<!--------------- 글쓰기 창 --------------->
		<div id="insertQnaD">
			<form id="qnaInsertForm" action="qnaInsert.pulu" method="post" >
				<table class="dummy" style="width: 1180px; border: 0">
					<tr>
						<td><input type="hidden" name="ID" value="${loginId}">
							...
							<table border="0" class="QNAList" style="width: 1180px; align-items: center">
								<colgroup>
									<col width="80px">
									<col width="*">
								</colgroup>
								...
								<tr>
									<td align="center" colspan="2">
										<input type="button" class="btn btn-default qnaInsertBtn" id="qnaInsert" onclick="qnaInsertBtn(); qnaInsertBr();" value="등록" style="width: 100px; margin-top: 10px;" /></td>
								</tr>
							</table>
						</td>
					</tr>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="base-table boardList">
							<table border="0" class="QNAList board_list" style="width: 1180px">
