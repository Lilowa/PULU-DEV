...
<style>
.form-control[name="ORDER_RECEIVE_ADDR2"] {
	margin-top: 5px;
}
...
.orderGoodsList table {
	margin-bottom: 30px;
}

.orderGoodsList label {
	margin-top: 5px;
	margin-bottom: 1px;
}
...
#page-wrapper2 {
    ...
    margin: 0 0 0 0px;
    padding: 0 30px;
    border-left: 0px solid #e7e7e700;
}
						...
						<div class="DetailForm">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group orderGoodsList">
										<label>상품(수량) : ${count.COUNT}</label>
										<c:choose>
													...
													<table>
														<tr>
															...
															<td>
																...
																<input class="form-control" type="text" value="${row.ORDER_GOODS_AMOUNT }" name="ORDER_GOODS_AMOUNT" readonly>
															</td>
														</tr>
													</table>
												</c:forEach>
							...
							<div class="panel-body">
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											<label>우편번호</label><br/>
											<div class="zipcode_form-group">
									            <button type="button" class="btn btn-primary zipcodeBtn" onclick="kakaoPost()">우편번호 찾기</button>
