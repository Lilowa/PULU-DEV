											...
											<div id="fileDiv">				
												<c:forEach var="row" items="${list}" varStatus="var">
													<p>
														...
														<input type="text" id="IMAGE_CATEGORY_${var.index }" name="IMAGE_CATEGORY_${var.index }" value="${row.IMAGE_CATEGORY }">
...
function fn_addFile(){
	...
	/*  function fn_updateBoard(){
		 let option = document.getElementById("IMAGE_CATEGORY_0").value;
		 var comSubmit = new ComSubmit("frm");
		
		 if(option == 1) {
				document.getElementById("IMAGE_CATEGORY_0").value = "1";
