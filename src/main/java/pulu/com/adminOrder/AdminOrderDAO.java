...
public class AdminOrderDAO extends AbstractDAO {
	...
	@SuppressWarnings("unchecked")
	public Map<String, Object> adminOrderGoodsCount(Map<String, Object> map) throws Exception {
		return (Map<String, Object>) selectOne("adminOrder.adminOrderGoodsCount", map);
	}
